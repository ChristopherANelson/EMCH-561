...
for i in range(0, 100):
    theta_lowei.append(Gradient_Descent(eta_low, iter_low, X_b, Y))
    eta_low = eta_low+0.005
    iter_low+5
...
plt.figure(figsize=(6.5,3))
plt.plot(data, life_satisfaction, 'o', markersize=7, label='training data')
plt.plot(X_model, gd_model_low_ei, label = "Low eta and low iteration Number")
